...
class Game extends Component {
    ...
    delay=()=>{
        ...
        if (width<=0) {
            this.state.width=0;
            this.state.runModal=!this.state.closeModal;
        }
        else {
            width--;
        ...
        return (
            <div>
                <div className={'container '}>
                    <div className={'row my-5 d-flex justify-content-lg-center'}>
                       <div className={'col-md-4 text-center'}>
                               <div className={'card'}>
                                   ...
                                   { isTrue?<div className={'card-body offset-1'}>
                                       <div className={'mb-3'}>
                                           <button onClick={()=>this.clickButton('first')}  className={'btn btn-info p-4 '}>{result1}</button>
                                           <button onClick={()=>this.clickButton('second')} className={'btn btn-info p-4 '}>{result2}</button>
                                       </div>
                                       <div>
                                   ...
                                   {isTrue? <div className={'card-footer'}>
                                       ...
                                       <div>
                                       <h1 className={'text-center'}>Your score is 0</h1>
                               ...
                               <Modal isOpen={runModal}  toggle={this.changeModal}>
                                   ...
                                   <ModalBody>
                                       {this.state.score>10 ?<div>
                                               ...
                                               <img src={'images/pleased.jpg'} className={'offset-2'}/>
                                           </div> :
                                           <div>
